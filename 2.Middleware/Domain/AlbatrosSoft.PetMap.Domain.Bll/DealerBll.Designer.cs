...
{
    /// <summary>
    /// Fachada de servicio que expone todas las operaciones de acceso y manipulación de datos para la entidad Dealer.
    /// </summary>
    public partial class DealerBll : DomainService<Dealer>
    {
    	/// <summary>
    	/// Inicializa una nueva instancia del servicio de manipulación de datos para la entidad Dealer.
    	/// </summary>
    	public DealerBll()
            : base(NaviUnitOfWork.Instance.DealerRepository)
        { 
    	}
    	...
    	public DealerBll(string connectionString)
            : base(NaviUnitOfWork.Instance.DealerRepository)
        {
