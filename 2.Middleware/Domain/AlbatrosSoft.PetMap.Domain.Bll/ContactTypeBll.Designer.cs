...
{
    /// <summary>
    /// Fachada de servicio que expone todas las operaciones de acceso y manipulación de datos para la entidad ContactType.
    /// </summary>
    public partial class ContactTypeBll : DomainService<ContactType>
    {
    	/// <summary>
    	/// Inicializa una nueva instancia del servicio de manipulación de datos para la entidad ContactType.
    	/// </summary>
    	public ContactTypeBll()
            : base(NaviUnitOfWork.Instance.ContactTypeRepository)
        { 
    	}
    	...
    	public ContactTypeBll(string connectionString)
            : base(NaviUnitOfWork.Instance.ContactTypeRepository)
        {
