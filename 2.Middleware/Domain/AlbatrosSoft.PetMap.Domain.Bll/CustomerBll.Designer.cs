...
{
    /// <summary>
    /// Fachada de servicio que expone todas las operaciones de acceso y manipulación de datos para la entidad Customer.
    /// </summary>
    public partial class CustomerBll : DomainService<Customer>
    {
    	/// <summary>
    	/// Inicializa una nueva instancia del servicio de manipulación de datos para la entidad Customer.
    	/// </summary>
    	public CustomerBll()
            : base(NaviUnitOfWork.Instance.CustomerRepository)
        { 
    	}
