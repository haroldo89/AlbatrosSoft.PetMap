...
{
    /// <summary>
    /// Fachada de servicio que expone todas las operaciones de acceso y manipulación de datos para la entidad CustomerBillingStatus.
    /// </summary>
    public partial class CustomerBillingStatusBll : DomainService<CustomerBillingStatus>
    {
    	/// <summary>
    	/// Inicializa una nueva instancia del servicio de manipulación de datos para la entidad CustomerBillingStatus.
    	/// </summary>
    	public CustomerBillingStatusBll()
            : base(NaviUnitOfWork.Instance.CustomerBillingStatusRepository)
        { 
    	}
    	...
    	public CustomerBillingStatusBll(string connectionString)
            : base(NaviUnitOfWork.Instance.CustomerBillingStatusRepository)
        {
