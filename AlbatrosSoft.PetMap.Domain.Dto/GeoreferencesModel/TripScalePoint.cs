...
namespace AlbatrosSoft.PetMap.Domain.Dto.GeoreferencesModel
{
    ...
    /// </summary>
    [XmlRoot("tripScalePoint")]
    [DataContract(Name = "tripScalePoint")]
    public partial class TripScalePoint : LocationPoint
    {
        /// <summary>
        ...
        /// <summary>
        /// Numero de la escala del punto de control.
        /// </summary>
        [DataMember(Name = "tripScale")]
        public int TripScale { get; set; }

        public TripScalePoint()
        {

        }

        //public TripScalePoint(ViewActivePoint point)
        //{
        //    if (point == null)
        //    {
        ...
        //public TripScalePoint(ViewCheckPointInfo point)
        //{
        //    if (point == null)
        //    {
        //        throw new ArgumentNullException("point", "Instancia del punto no puede ser un valor nulo.");
