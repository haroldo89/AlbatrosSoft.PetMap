...
*/
LayoutHelper.hideLeftBarLogin = function () {
...
*/
LayoutHelper.showLeftBarLogin = function () {
    //Muestra Div de login
    document.getElementById("headerLogin").setAttribute("style", "display:inline");
    ...
    $(".content").slideToggle(400, function () {
        //Validar si el div no esta visible
        if (!$(".content").is(":visible")) {
            LayoutHelper.hideLeftBarLogin();
        }
    });
}
...
LayoutHelper.isVisible = function (controlName) {
    ...
    if (control) {
        ...
        isVisible = visibilityAttribute != null && visibilityAttribute != "none";
    }
    return isVisible;
}
