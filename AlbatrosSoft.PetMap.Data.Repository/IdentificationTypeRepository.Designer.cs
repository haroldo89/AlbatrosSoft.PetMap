...
{
    /// <summary>
    /// Controla todas las operaciones de persistencia hacia el origen de datos para la entidad IdentificationType.
    /// </summary>
    public partial class IdentificationTypeRepository : ObjectRepository<IdentificationType>
    {
    	/// <summary>
        /// Inicializa una nueva instancia del servicio que expone las operaciones de manipulación de datos para la entidad de dominio IdentificationType.
        /// </summary>
